    ...
    >
      ...
      <div className="flex flex-col relative">
        <div className="flex items-center">
          <span className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-bold uppercase mr-2 text-green-700 ring-1 ring-green-600/20 ring-inset">{props.type}</span>
        ...
        <div className="flex justify-between mt-4">
          <div className="flex">
            ...
            <div className="flex flex-col">
              <span className="text-gray-900 font-semibold">{props.company}</span>
