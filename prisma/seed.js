...
const industryOptions = ["Tech", "Finance", "Health", "Education", "Retail"];
const orgTypes = ["startup", "non_profit", "large_corporation"];
const teamSizes = ["1-10", "11-50", "51-200", "201-500", "500+"];

async function getCitiesByState(countryCode) {
...
async function main() {
  for (let i = 1; i < 200; i++) {
    ...
    const cities = await getCitiesByState(country.isoCode);

    const company = await prisma.company.create({
      data: {
        name: `company${i + 1}`,
        email: `companyy${i + 1}@example.com`,
        description: faker.lorem.paragraph(),
        benefits: getRandomItems(benefitsOptions),
        phone: faker.phone.number(),
        location: country?.name || "",
        industry: getRandom(industryOptions),
        organizationType: getRandom(orgTypes),
        teamSize: getRandom(teamSizes),
        founded: new Date("2010-01-01"),
        vision: `To redefine ${faker.word.adjective()} ${faker.word.noun()}.`,
        website: `https://www.company${i + 1}.com`,
        logo: "https://job-kerja-pilot.s3.ap-southeast-2.amazonaws.com/logo/1743651425752-astralis-logo.png",
        banner:
          "https://job-kerja-pilot.s3.ap-southeast-2.amazonaws.com/banner/1743651428366-astralis-banner.jpeg",
      },
    });
    ...
    for (let j = 0; j < jobCount; j++) {
      await prisma.job.create({
        data: {
          ...
          requirements: getRandomItems(requirementOptions),
          desirable: [],
          benefits: getRandomItems(benefitsOptions),
          jobType: getRandom(["full-time", "part-time"]),
          jobLevel: getRandom(["Junior", "Mid", "Senior", "Manager"]),
          experience: getRandom(["1-3", "3-5", ">5"]),
          education: getRandom(["Bachelor Degree", "Master Degree", "PhD"]),
          jobTags: getRandomItems([
            "remote",
            "onsite",
            "ai",
            "frontend",
  ...
  console.log("✅ Seeded 200 companies and their jobs!");
}
